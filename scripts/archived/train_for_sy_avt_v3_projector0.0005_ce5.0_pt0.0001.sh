...
ALIGN_VISION_LATENT_LOSS_WEIGHT=0.0005
LOAD_CKPT=9.10_ablation_avt_v3.1_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-proj-wt0.0001/checkpoint-600
...
torchrun --nproc-per-node=8 --master-port=29501 -m src.main \
  ...
  --log_file "./log.txt" \
  --load_model_path /mmu_vcg_ssd/shiyang06/Project/Latent_Think/checkpoint/avt_v3.1/${LOAD_CKPT} \
