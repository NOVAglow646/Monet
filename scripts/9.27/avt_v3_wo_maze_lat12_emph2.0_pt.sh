...
LOAD_CKPT=9.25_avt_sft_wo_maze_cnt_ce5.0
SAVE_CKPT=9.26_avt_v3_pt_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGN_VISION_LATENT_LOSS_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}
