...
TEACHER=9.27_avt_sft_wo_maze_ce2.0
...
SAVE_CKPT=10.1_avt_v4_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-wt${ALIGNMENT_WEIGHT}_emph-wt${EMPHASIZE_LATENT_WEIGHT}
source /pfs/wangzihao11/miniconda3/bin/activate
conda activate mirage
cd /mmu_vcg_ssd/shiyang06/Project/Latent_Think/abstract-visual-token
export TOKENIZERS_PARALLELISM=false
...
ckpt_name=${SAVE_CKPT}
step=200
src=/mmu_vcg_ssd/shiyang06/Project/Latent_Think/checkpoint/avt_v4/${ckpt_name}/checkpoint-${step}
output=/mmu_vcg_ssd/shiyang06/Project/Latent_Think/checkpoint/avt_v4/${ckpt_name}-checkpoint-${step}.zip
...
python /mmu_vcg_ssd/shiyang06/Tool/huggingface.py --item /mmu_vcg_ssd/shiyang06/Project/Latent_Think/checkpoint/avt_v4/${ckpt_name}-checkpoint-${step}.zip
