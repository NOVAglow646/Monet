...
SAVE_CKPT=9.11_ablation_avt_v3.1_latent${LATENT_SIZE}_ce${CE_EMPHASIZE_FACTOR}_align-proj-wt${ALIGN_VISION_LATENT_LOSS_WEIGHT}
...
torchrun --nproc-per-node=8 --master-port=29501 -m src.main \
  ...
  --save_model_path /mmu_vcg_ssd/shiyang06/Project/Latent_Think/checkpoint/avt_v3.1/${SAVE_CKPT} \
