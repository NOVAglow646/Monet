...
python3 -m new.dataset_utils.api_anno_from_stage2 \
  --stage2 /home/dids/shiyang/codes/abstract-visual-token/new/created_dataset/filtered_data/CoM_w_MathVista/stage2_strong_out.jsonl \
  --out-json /home/dids/shiyang/codes/abstract-visual-token/new/created_dataset/filtered_data/CoM_w_MathVista/filtered_train_w_metadat_from_stage2.json \
...
cd /home/dids/shiyang/codes/abstract-visual-token
python3 -m new.dataset_utils.api_anno_from_stage2 \
  --stage2 /home/dids/shiyang/codes/abstract-visual-token/new/created_dataset/filtered_data/ReFocus/stage2_strong_out.jsonl \
  --out-json /home/dids/shiyang/codes/abstract-visual-token/new/created_dataset/filtered_data/ReFocus/filtered_train_w_metadat_from_stage2.json \
  --api_model_name deepseek-chat \
  --max-records 2
